...
/**
 * initializes and/or activates most of the visual components of the game
 */
public class GameWorld extends World implements CollisionListener, ActionListener {
     ...
     * if player is on the edge of a platform, automatically transport to the top of the platform
     * if player falls to the spikes, end the game
     * if player is caught by an enemy, end the game
     */
    ...
    /**
     * make a new enemy every two seconds
     * randomly select one of three types of enemy
     * randomly place somewhere within the game world
     */
    @Override
